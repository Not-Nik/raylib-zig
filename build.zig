...
pub fn build(b: *Builder) void {
    ...
    const examples = [_]Program{
        ...
        .{
            .name = "draw_2d",
            .path = "tests/draw_2d.zig",
            .desc = "Testing workaround on 2D drawing functions",
        },
        .{
            .name = "draw_sphere",
            .path = "tests/draw_sphere.zig",
            .desc = "Testing workaround on DrawSphere",
        },
        .{
            .name = "del_exit_key",
            .path = "tests/del_exit_key.zig",
            .desc = "Testing disabling of exit key",
        },
    };

    const examples_step = b.step("examples", "Builds all the examples and tests");
